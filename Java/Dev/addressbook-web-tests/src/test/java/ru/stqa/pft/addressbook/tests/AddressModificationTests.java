...
public class AddressModificationTests extends TestBase {
  ...
  public void testsAddressModification(){
    ...
    if (! app.getContactHelper().isThereAnyAddress()){
      app.getContactHelper().createAAddress(new AddressData("Agnieszka", "Sara","Budzyńska",null, null, null));
    }
    ...
    AddressData group = new AddressData("Agnieszka", "Sara","Budzyńska", null, null, null);
